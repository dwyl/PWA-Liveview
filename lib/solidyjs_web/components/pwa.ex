defmodule SolidyjsWeb.Pwa do
  ...
  def svg(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width={round(@height * 2.65)} height={@height}
      viewBox="0 0 1952 734.93" xml:space="preserve" class={@class}>
