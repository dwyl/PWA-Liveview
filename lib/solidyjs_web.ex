defmodule SolidyjsWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: SolidyjsWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SolidyjsWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import SolidyjsWeb.CoreComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: SolidyjsWeb.Endpoint,
        router: SolidyjsWeb.Router,
        statics: SolidyjsWeb.static_paths()
    end
  end
