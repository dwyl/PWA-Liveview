defmodule LiveviewPwaWeb.Api.UserTokenController do
  ...
  #     is_maybe_refresh_token = Map.get(conn.cookies, "refresh")

  #     with true <- is_maybe_refresh_token != nil,
  #          {:ok, new_access_token, new_refresh_token} <-
  #            verify_and_access_refresh(is_maybe_refresh_token, user_id),
  #          {:ok, _} <- LiveviewPwa.User.update_token(user_id, new_access_token, new_refresh_token) do
