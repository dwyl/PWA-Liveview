...
registerRoute(/.*\.(js|css|woff2?|png|jpg|jpeg|svg|ico)/, new CacheFirst({
...
registerRoute(({
  url
}) => url.pathname.startsWith("/live/longpoll"), new NetworkOnly(), 'GET');
registerRoute(({
  url
}) => url.pathname.startsWith("/live/websocket"), new NetworkOnly(), 'GET');
registerRoute(({
  url
}) => url.pathname.startsWith("/test"), new NetworkOnly(), 'GET');
registerRoute(({
  url
